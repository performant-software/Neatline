...
function neatline_createDemoExhibit()
{
    ...
    // Create the exhibit.
    $exhibit = new NeatlineExhbit;

    // Populate.
    $neatline->name =                   '(Sample Exhibit): NYC Parks';
    $neatline->added =                  '2012-01-01 00:00:00';
    $neatline->is_map =                 1;
    $neatline->is_timeline =            0;
    $neatline->is_items =               1;
    $neatline->is_items =               1;
    $neatline->items_h_pos =            'right';
    $neatline->items_v_pos =            'bottom';
    $neatline->items_height =           'full';
    $neatline->default_map_zoom =       12;
    $neatline->default_map_bounds =     '-8255563.3238613,4944376.9470808,-8210847.6623207,5001551.8442302';
    $neatline->default_vector_opacity = 8;
    $neatline->default_stroke_opacity = 100;
    $neatline->default_stroke_color =   '#281ee6';
    $neatline->save();
