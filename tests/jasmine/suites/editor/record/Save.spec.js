...
describe('Record Form Save', function() {
  ...
  it('should issue PUT request when "Save" is clicked', function() {
    ...
    inputs.fillOpacity.     val('10').           trigger('change');
    ...
    inputs.zindex.          val('15').          trigger('change');
    inputs.weight.          val('16').          trigger('change');
    inputs.startDate.       val('17').          trigger('change');
    inputs.endDate.         val('18').          trigger('change');
    inputs.afterDate.       val('19').          trigger('change');
    inputs.beforeDate.      val('20').          trigger('change');
    inputs.pointImage.      val('21').          trigger('change');
    inputs.wmsAddress.      val('22').          trigger('change');
    inputs.wmsLayers.       val('23').          trigger('change');
    inputs.minZoom.         val('24').          trigger('change');
    inputs.maxZoom.         val('25').          trigger('change');
    inputs.mapFocus.        val('26').          trigger('change');
    inputs.mapZoom.         val('27').          trigger('change');
    ...
    expect(params.fill_opacity).      toEqual('10');
    ...
    expect(params.zindex).            toEqual('15');
    expect(params.weight).            toEqual('16');
    expect(params.start_date).        toEqual('17');
    expect(params.end_date).          toEqual('18');
    expect(params.after_date).        toEqual('19');
    expect(params.before_date).       toEqual('20');
    expect(params.point_image).       toEqual('21');
    expect(params.wms_address).       toEqual('22');
    expect(params.wms_layers).        toEqual('23');
    expect(params.min_zoom).          toEqual('24');
    expect(params.max_zoom).          toEqual('25');
    expect(params.map_focus).         toEqual('26');
    expect(params.map_zoom).          toEqual('27');
