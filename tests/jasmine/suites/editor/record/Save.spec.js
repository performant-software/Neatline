...
describe('Record Form Save', function() {
  ...
  it('should issue PUT request when "Save" is clicked', function() {
    ...
    inputs.fillOpacitySelect.   val('11').          trigger('change');
    inputs.strokeOpacity.       val('12').          trigger('change');
    inputs.strokeOpacitySelect. val('13').          trigger('change');
    ...
    expect(params.fill_opacity_select).   toEqual('11');
    expect(params.stroke_opacity).        toEqual('12');
    expect(params.stroke_opacity_select). toEqual('13');
