    ...
    extends Neatline_Test_AppTestCase
{
    ...
    public function testBuildJsonData()
    {
        ...
        $record->tags               = '3';
        $record->fill_color         = '4';
        $record->select_color       = '5';
        $record->stroke_color       = '6';
        $record->fill_opacity       = 7;
        ...
        $this->assertEquals($data['fill_color'],        '4');
        $this->assertEquals($data['select_color'],      '5');
        $this->assertEquals($data['stroke_color'],      '6');
        $this->assertEquals($data['fill_opacity'],      7);
