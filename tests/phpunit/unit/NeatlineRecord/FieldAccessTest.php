    ...
    extends Neatline_Test_AppTestCase
{
    ...
    public function testFieldAccess()
    {
        ...
        $record->map_zoom           = 10;
        $record->presenter          = '11';
        $record->fill_color         = '12';
        $record->select_color       = '13';
        $record->stroke_color       = '14';
        $record->fill_opacity       = 15;
        ...
        $this->assertEquals($record->fill_color,        '12');
        $this->assertEquals($record->select_color,      '13');
        $this->assertEquals($record->stroke_color,      '14');
        $this->assertEquals($record->fill_opacity,      15);
