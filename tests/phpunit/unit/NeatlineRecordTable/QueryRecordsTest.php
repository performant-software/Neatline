...
class NeatlineRecordTableTest_QueryRecords extends Neatline_TestCase
{
    ...
    public function testQueryRecords()
    {
        ...
        $this->assertEquals($records[0]['fill_color'],      '12');
        $this->assertEquals($records[0]['select_color'],    '14');
        $this->assertEquals($records[0]['stroke_color'],    '16');
        $this->assertEquals($records[0]['fill_opacity'],    18);
        ...
        $this->assertEquals($records[1]['fill_color'],      '11');
        $this->assertEquals($records[1]['select_color'],    '13');
        $this->assertEquals($records[1]['stroke_color'],    '15');
        $this->assertEquals($records[1]['fill_opacity'],    17);
