...
class AclTest_ResearcherRecordsAllow extends Neatline_DefaultCase
{
    ...
    public function setUp()
    {
        ...
        $user1 = $this->loginAsResearcher('user1');
        $this->exhibit = $this->__exhibit();
        $this->record1 = $this->__record($this->exhibit);

        $user2 = $this->loginAsResearcher('user2');
    ...
    /**
     * Researchers should be able to create their own records to their own
     * exhibits.
     */
    ...
    /**
     * Researchers should be able to update their own records in their own
     * exhibits.
     */
    ...
    /**
     * Researchers should be able to delete their own records in their own
     * exhibits.
     */
    ...
    /**
     * Researchers should be able to update other users' records in their
     * own exhibits.
     */
    ...
    /**
     * Researchers should be able to delete other users' records in their
     * own exhibits.
     */
