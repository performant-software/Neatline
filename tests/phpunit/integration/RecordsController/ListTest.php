...
class RecordsControllerTest_List extends Neatline_TestCase
{
    ...
    public function testList()
    {
        ...
        $record1->fill_opacity          = 23;
        $record2->fill_opacity          = 24;
        $record1->fill_opacity_select   = 25;
        $record2->fill_opacity_select   = 26;
        $record1->stroke_opacity        = 27;
        $record2->stroke_opacity        = 28;
        $record1->stroke_opacity_select = 29;
        $record2->stroke_opacity_select = 30;
        ...
        $this->assertEquals($r[0]->fill_opacity,            24);
        $this->assertEquals($r[0]->fill_opacity_select,     26);
        $this->assertEquals($r[0]->stroke_opacity,          28);
        $this->assertEquals($r[0]->stroke_opacity_select,   30);
        ...
        $this->assertEquals($r[1]->fill_opacity,            23);
        $this->assertEquals($r[1]->fill_opacity_select,     25);
        $this->assertEquals($r[1]->stroke_opacity,          27);
        $this->assertEquals($r[1]->stroke_opacity_select,   29);
