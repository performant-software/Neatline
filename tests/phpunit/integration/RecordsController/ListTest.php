...
class RecordsControllerTest_List extends Neatline_TestCase
{
    ...
    public function testList()
    {
        ...
        $record1->weight            = 31;
        $record2->weight            = 32;
        $record1->start_date        = '33';
        $record2->start_date        = '34';
        $record1->end_date          = '35';
        $record2->end_date          = '36';
        $record1->after_date        = '37';
        $record2->after_date        = '38';
        $record1->before_date       = '39';
        $record2->before_date       = '40';
        $record1->point_image       = '41';
        $record2->point_image       = '42';
        $record1->wms_address       = '43';
        $record2->wms_address       = '44';
        $record1->wms_layers        = '45';
        $record2->wms_layers        = '46';
        $record1->min_zoom          = 47;
        $record2->min_zoom          = 48;
        $record1->max_zoom          = 49;
        $record2->max_zoom          = 50;
        $record1->map_zoom          = 51;
        $record2->map_zoom          = 52;
        $record1->map_focus         = '53';
        $record2->map_focus         = '54';
        ...
        $this->assertEquals($records[0]->zindex,            30);
        $this->assertEquals($records[0]->weight,            32);
        $this->assertEquals($records[0]->start_date,        '34');
        $this->assertEquals($records[0]->end_date,          '36');
        $this->assertEquals($records[0]->after_date,        '38');
        $this->assertEquals($records[0]->before_date,       '40');
        $this->assertEquals($records[0]->point_image,       '42');
        $this->assertEquals($records[0]->wms_address,       '44');
        $this->assertEquals($records[0]->wms_layers,        '46');
        $this->assertEquals($records[0]->min_zoom,          48);
        $this->assertEquals($records[0]->max_zoom,          50);
        $this->assertEquals($records[0]->map_zoom,          52);
        $this->assertEquals($records[0]->map_focus,         '54');
        ...
        $this->assertEquals($records[1]->zindex,            29);
        $this->assertEquals($records[1]->weight,            31);
        $this->assertEquals($records[1]->start_date,        '33');
        $this->assertEquals($records[1]->end_date,          '35');
        $this->assertEquals($records[1]->after_date,        '37');
        $this->assertEquals($records[1]->before_date,       '39');
        $this->assertEquals($records[1]->point_image,       '41');
        $this->assertEquals($records[1]->wms_address,       '43');
        $this->assertEquals($records[1]->wms_layers,        '45');
        $this->assertEquals($records[1]->min_zoom,          47);
        $this->assertEquals($records[1]->max_zoom,          49);
        $this->assertEquals($records[1]->map_zoom,          51);
        $this->assertEquals($records[1]->map_focus,         '53');
