(function() {
    ...
    (i = function() {
        ...
        var e, s, r, o, n;
        for (s = new i(), r = 0, o = (n = t.childNodes).length; r < o; r++) e = n[r], s.add_node(e);
        return s.parsed;
    }, e = function() {
        function t(e, s) {
        ...
        return t.prototype.set_default_values = function() {
            ...
            var e, s, i, r, o;
            for (e = "", i = 0, r = (o = this.results_data).length; i < r; i++) (s = o[i]).group ? e += this.result_add_group(s) : e += this.result_add_option(s), 
            ...
            for (this.no_results_clear(), r = 0, t = (n = this.get_search_text()).replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), 
            i = this.search_contains ? "" : "^", s = new RegExp(i + t, "i"), c = new RegExp(t, "i"), 
            a = 0, _ = (u = this.results_data).length; a < _; a++) (e = u[a]).search_match = !1, 
            o = null, this.include_option_in_results(e) && (e.group && (e.group_match = !1, 
            e.active_options = 0), null != e.group_array_index && this.results_data[e.group_array_index] && (0 === (o = this.results_data[e.group_array_index]).active_options && o.search_match && (r += 1), 
            o.active_options += 1), e.group && !this.group_search || (e.search_text = e.group ? e.label : e.html, 
            e.search_match = this.search_string_match(e.search_text, s), e.search_match && !e.group && (r += 1), 
            e.search_match ? (n.length && (h = e.search_text.search(c), l = e.search_text.substr(0, h + n.length) + "</em>" + e.search_text.substr(h + n.length), 
            e.search_text = l.substr(0, h) + "<em>" + l.substr(h)), null != o && (o.group_match = !0)) : null != e.group_array_index && this.results_data[e.group_array_index].search_match && (e.search_match = !0)));
            return this.result_clear_highlight(), r < 1 && n.length ? (this.update_results_content(""), 
            this.no_results(n)) : (this.update_results_content(this.results_option_build()), 
            this.winnow_results_set_highlight());
        }, t.prototype.search_string_match = function(t, e) {
            var s, i, r, o;
            if (e.test(t)) return !0;
            if (this.enable_split_word_search && (t.indexOf(" ") >= 0 || 0 === t.indexOf("[")) && (i = t.replace(/\[|\]/g, "").split(" ")).length) for (r = 0, 
            o = i.length; r < o; r++) if (s = i[r], e.test(s)) return !0;
        ...
        "chosen": function(i) {
            return e.browser_is_supported() ? this.each(function(e) {
                var r, o;
                o = (r = t(this)).data("chosen"), "destroy" === i && o ? o.destroy() : o || r.data("chosen", new s(this, i));
            }) : this;
        }
    }), s = function(e) {
        function s() {
        ...
        return n(s, e), s.prototype.setup = function() {
            ...
            if (t.length) {
                ...
                r = i + o, s = this.result_highlight.position().top + this.search_results.scrollTop(), 
            ...
            var t;
            return this.results_showing || this.is_multiple ? this.result_highlight ? (t = this.result_highlight.prevAll("li.active-result"), 
            t.length ? this.result_do_highlight(t.first()) : (this.choices_count() > 0 && this.results_hide(), 
            ...
            var e, s, i, r, o, n, h, l;
            if (this.is_multiple) {
                for (0, n = 0, r = "position:absolute; left: -1000px; top: -1000px; display:none;", 
                h = 0, l = (o = [ "font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing" ]).length; h < l; h++) r += (i = o[h]) + ":" + this.search_field.css(i) + ";";
                return (e = t("<div />", {
                    "style": r
                })).text(this.search_field.val()), t("body").append(e), n = e.width() + 25, e.remove(), 
                s = this.container.outerWidth(), n > s - 10 && (n = s - 10), this.search_field.css({
                    "width": n + "px"
                });
            }
        }, s;
