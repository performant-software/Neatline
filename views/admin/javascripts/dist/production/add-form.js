!function(t, e) {
    ...
    var d = function() {
        ...
        "chop": function(t, s) {
            return null == t ? [] : (t = e(t), s = ~~s, s > 0 ? t.match(new RegExp(".{1," + s + "}", "g")) : [ t ]);
        },
        "clean": function(t) {
        ...
        "prune": function(t, s, i) {
            ...
            }, n = t.slice(0, s + 1).replace(/.(?=\W*\w*$)/g, r);
            return n = n.slice(n.length - 2).match(/\w\w/) ? n.replace(/\s*\S+$/, "") : p.rtrim(n.slice(0, n.length - 1)), 
            (n + i).length > t.length ? t : t.slice(0, n.length) + i;
        },
        "words": function(t, e) {
        ...
        "toNumber": function(t, e) {
            return t ? (t = p.trim(t), t.match(/^-?\d+(?:\.\d+)?$/) ? o(o(t).toFixed(~~e)) : NaN) : 0;
        },
    ...
    (i = function() {
        ...
        return o(s, e), s.prototype.setup = function() {
