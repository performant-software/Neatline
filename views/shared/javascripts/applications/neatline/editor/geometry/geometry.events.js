...
Neatline.module('Editor.Geometry', { startWithParent: false,
  ...
  Form.addInitializer(function() {
    ...
    Neatline.vent.bindTo(
      Neatline.vent, 'editor:form:open', function(model, focus) {
     ...
     */
    Neatline.vent.bindTo(
      Neatline.vent, 'editor:form:close', function(model) {
     ...
     */
    Neatline.vent.bindTo(
      Neatline.vent, 'editor:form:updateMap', function(settings) {
